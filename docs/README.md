...
1. ✅ Auto generated swagger documentation, TF defined CloudWatch dashboard & alarms
...
1. ✅ Performance testing using k6, especially breakpoint-point type
...
k6 run performance-tests/breaking-point.js
```
